...
| Data signatures                                                         |
|:------------------------------------------------------------------------|
| header_names_mismatch( pipe delimited headers: $${\color{green}str}$$ ) |

| Call signatures                                                                                                             |
|:----------------------------------------------------------------------------------------------------------------------------|
| header_names_mismatch( pipe delimited headers: [Term](https://github.com/csvpath/csvpath/blob/main/docs/matching.md#term) ) |
