...
PATH = f"tests{os.sep}csvpaths{os.sep}examples{os.sep}csvpaths_examples_references{os.sep}assets{os.sep}sourcemode.csvpaths"
PATH2 = f"tests{os.sep}csvpaths{os.sep}examples{os.sep}csvpaths_examples_references{os.sep}assets{os.sep}sourcemode2.csvpaths"
