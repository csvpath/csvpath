...
ORDERS = f"tests{os.sep}csvpaths{os.sep}examples{os.sep}csvpaths_examples_ckan{os.sep}orders.json"
FILES = (
    f"tests{os.sep}csvpaths{os.sep}examples{os.sep}csvpaths_examples_ckan{os.sep}csvs"
)
...
class TestCsvPathsExamplesCkan(unittest.TestCase):
    def test_ckan_visibility(self):
        ...
        paths.file_manager.add_named_files_from_dir(FILES)
        paths.paths_manager.add_named_paths_from_json(ORDERS)
        #
        #
        #
