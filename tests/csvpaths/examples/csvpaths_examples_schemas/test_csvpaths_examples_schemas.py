...
class TestCsvPathsExamplesSchemas(unittest.TestCase):
    @classmethod
    def setup_class(cls):
        paths = CsvPaths()
        ...
        paths.file_manager.add_named_file(
            name="schemas",
            path=f"tests{os.sep}csvpaths{os.sep}examples{os.sep}csvpaths_examples_schemas{os.sep}people.csv",
        )
        paths.paths_manager.add_named_paths_from_file(
            name="schemas",
            file_path=f"tests{os.sep}csvpaths{os.sep}examples{os.sep}csvpaths_examples_schemas{os.sep}schemas.csvpath",
        )
