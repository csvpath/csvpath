...
class Paths:
    DIR_BASE = pathu.resep("tests/csvpaths/test_resources/test_dirs/")

    TEMP_DIR_1 = pathu.resep("tests/csvpaths/test_resources/test_dirs/xyz")
    TEMP_DIR_2 = pathu.resep("tests/csvpaths/test_resources/test_dirs/pdq")
    TEMP_DIR_3 = pathu.resep("tests/csvpaths/test_resources/test_dirs/xyz/ijk")
    ...
    TEMP_FILE_1 = pathu.resep("tests/csvpaths/test_resources/test_dirs/abc_1.txt")
    TEMP_FILE_2 = pathu.resep("tests/csvpaths/test_resources/test_dirs/xyz/abc_2.txt")
    TEMP_FILE_3 = pathu.resep("tests/csvpaths/test_resources/test_dirs/pdq/abc_3.txt")
    TEMP_FILE_4 = pathu.resep(
        "tests/csvpaths/test_resources/test_dirs/xyz/ijk/abc_4.txt"
    )
...
class TestCsvPathsDirsLocal(unittest.TestCase):
    def test_local_crud_files(self):
        ...
        lst = Nos(Paths.DIR_BASE).listdir(recurse=True, files_only=False)
        ...
        assert pathu.resep("tests/csvpaths/test_resources/test_dirs/xyz") in lst
        assert pathu.resep("tests/csvpaths/test_resources/test_dirs/pdq") in lst
        assert pathu.resep("tests/csvpaths/test_resources/test_dirs/xyz/ijk") in lst

        lst = Nos("tests/csvpaths/test_resources/test_dirs/").listdir(
        ...
        lst = Nos("tests/csvpaths/test_resources/test_dirs/xyz").listdir(recurse=False)
        assert lst is not None
        assert "abc_2.txt" in lst
        assert "ijk" in lst

        lst = Nos("tests/csvpaths/test_resources/test_dirs/xyz").listdir(
            recurse=False, files_only=True
        )
        assert lst is not None
        assert "abc_2.txt" in lst
        ...
        lst = Nos("tests/csvpaths/test_resources/test_dirs/xyz/ijk").listdir(
            recurse=True
        )
        assert lst is not None
        assert len(lst) == 1
