...
EMAIL1 = f"tests{os.sep}csvpath{os.sep}test_resources{os.sep}emails1.csv"
EMAIL2 = f"tests{os.sep}csvpath{os.sep}test_resources{os.sep}emails2.csv"
EMAIL3 = f"tests{os.sep}csvpath{os.sep}test_resources{os.sep}emails3.csv"


class TestCsvPathFunctionsEmail(unittest.TestCase):
