...
PATH2 = f"tests{os.sep}csvpath{os.sep}examples{os.sep}csvpath_examples_max_increase{os.sep}Automobiles_Annual_Imports_and_Exports_Port_Authority_of_NY.csv"
FOOD = f"tests{os.sep}csvpath{os.sep}test_resources{os.sep}food.csv"


class TestCsvPathFunctionsPercentUnique(unittest.TestCase):
