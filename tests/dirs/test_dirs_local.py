...
TEMP_DIR_1 = "tests/test_resources/test_dirs/xyz"
TEMP_DIR_2 = "tests/test_resources/test_dirs/pdq"
TEMP_DIR_3 = "tests/test_resources/test_dirs/xyz/ijk"
...
TEMP_FILE_1 = "tests/test_resources/test_dirs/abc_1.txt"
TEMP_FILE_2 = "tests/test_resources/test_dirs/xyz/abc_2.txt"
TEMP_FILE_3 = "tests/test_resources/test_dirs/pdq/abc_3.txt"
TEMP_FILE_4 = "tests/test_resources/test_dirs/xyz/ijk/abc_4.txt"
...
class TestDirsLocal(unittest.TestCase):
    def test_local_crud_files(self):
        ...
        assert "tests/test_resources/test_dirs/xyz" in lst
        assert "tests/test_resources/test_dirs/pdq" in lst
        assert "tests/test_resources/test_dirs/xyz/ijk" in lst

        lst = Nos("tests/test_resources/test_dirs/").listdir(
            recurse=False, files_only=True
        )
        assert lst is not None
        assert TEMP_FILENAME_1 in lst
        assert TEMP_FILENAME_2 not in lst
        assert TEMP_FILENAME_3 not in lst
        assert TEMP_FILENAME_4 not in lst
        ...
        assert lst is not None
        assert TEMP_DIR_1 in lst
        assert TEMP_DIR_2 in lst
        assert TEMP_DIR_3 in lst
