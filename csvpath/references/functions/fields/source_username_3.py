...
class SourceUsername3(Function3):
    #
    ...
    SUMMARY = (
        "The login username of the named source entry (by name) for "
        "the resolved named-file, read from definition.json's "
        "sources.<name>.username. Requires a source name argument."
    )
    ...
    SOURCE = "definition"
    KEY = {
        Reference3.FILES: "sources.{}.username",
    }
