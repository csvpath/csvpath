...
class DestinationUsername3(Function3):
    #
    ...
    SUMMARY = (
        "The login username of the named destination entry (by name) "
        "for the resolved named-paths group, read from definition."
        "json's destinations.<name>.username. Requires a destination "
        "name argument."
    )
    ...
    SOURCE = "definition"
    KEY = {
        Reference3.CSVPATHS: "destinations.{}.username",
    }
