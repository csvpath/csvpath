...
_lr_productions = [
    ...
    ("expressions -> expression", "expressions", 1, "p_expressions", "matcher.py", 146),
    (
    ...
    ("expression -> header", "expression", 1, "p_expression", "matcher.py", 153),
    (
    ...
    ("equality -> function op term", "equality", 3, "p_equality", "matcher.py", 180),
    (
    ...
    ("equality -> term op term", "equality", 3, "p_equality", "matcher.py", 187),
    ("equality -> term op function", "equality", 3, "p_equality", "matcher.py", 188),
    (
    ...
    ("equality -> equality op term", "equality", 3, "p_equality", "matcher.py", 190),
    (
    ...
    ("op -> EQUALS", "op", 1, "p_op", "matcher.py", 200),
    ("op -> OPERATION", "op", 1, "p_op", "matcher.py", 201),
    (
        "assignment -> var ASSIGNMENT var",
        "assignment",
        3,
    ...
    ("term -> QUOTED_NAME", "term", 1, "p_term", "matcher.py", 219),
    ("term -> QUOTE DATE QUOTE", "term", 3, "p_term", "matcher.py", 220),
    ("term -> QUOTE NUMBER QUOTE", "term", 3, "p_term", "matcher.py", 221),
    ("term -> NUMBER", "term", 1, "p_term", "matcher.py", 222),
    ("term -> REGEX", "term", 1, "p_term", "matcher.py", 223),
    (
        "var_or_header -> header",
        "var_or_header",
        1,
    ...
    ("var_or_header -> var", "var_or_header", 1, "p_var_or_header", "matcher.py", 232),
    ("var -> VAR_SYM NAME", "var", 2, "p_var", "matcher.py", 237),
    ("var -> VAR_SYM NAME_LINE", "var", 2, "p_var", "matcher.py", 238),
    ("header -> HEADER_SYM NAME", "header", 2, "p_header", "matcher.py", 244),
    ("header -> HEADER_SYM NUMBER", "header", 2, "p_header", "matcher.py", 245),
    ("header -> HEADER_SYM NAME_LINE", "header", 2, "p_header", "matcher.py", 246),
]
