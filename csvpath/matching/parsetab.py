...
_lr_productions = [
    ...
    ("expression -> function", "expression", 1, "p_expression", "matcher.py", 161),
    (
    ...
    ("expression -> header", "expression", 1, "p_expression", "matcher.py", 163),
    (
    ...
    ("equality -> function op term", "equality", 3, "p_equality", "matcher.py", 190),
    (
    ...
    ("equality -> term op term", "equality", 3, "p_equality", "matcher.py", 197),
    ("equality -> term op function", "equality", 3, "p_equality", "matcher.py", 198),
    (
    ...
    ("equality -> equality op term", "equality", 3, "p_equality", "matcher.py", 200),
    (
    ...
    ("op -> EQUALS", "op", 1, "p_op", "matcher.py", 210),
    ("op -> OPERATION", "op", 1, "p_op", "matcher.py", 211),
    (
        "assignment -> var ASSIGNMENT var",
        "assignment",
        3,
    ...
    ("term -> QUOTED_NAME", "term", 1, "p_term", "matcher.py", 229),
    ("term -> QUOTE DATE QUOTE", "term", 3, "p_term", "matcher.py", 230),
    ("term -> QUOTE NUMBER QUOTE", "term", 3, "p_term", "matcher.py", 231),
    ("term -> NUMBER", "term", 1, "p_term", "matcher.py", 232),
    ("term -> REGEX", "term", 1, "p_term", "matcher.py", 233),
    (
        "var_or_header -> header",
        "var_or_header",
        1,
    ...
    ("var_or_header -> var", "var_or_header", 1, "p_var_or_header", "matcher.py", 242),
    ("var -> VAR_SYM NAME", "var", 2, "p_var", "matcher.py", 247),
    ("var -> VAR_SYM NAME_LINE", "var", 2, "p_var", "matcher.py", 248),
    ("header -> HEADER_SYM NAME", "header", 2, "p_header", "matcher.py", 254),
    ("header -> HEADER_SYM NUMBER", "header", 2, "p_header", "matcher.py", 255),
    ("header -> HEADER_SYM NAME_LINE", "header", 2, "p_header", "matcher.py", 256),
]
