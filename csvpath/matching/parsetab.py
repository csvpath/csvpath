...
_lr_productions = [
    ...
    ("expressions -> expression", "expressions", 1, "p_expressions", "matcher.py", 153),
    (
    ...
    ("expression -> function", "expression", 1, "p_expression", "matcher.py", 158),
    (
    ...
    ("expression -> header", "expression", 1, "p_expression", "matcher.py", 160),
    (
    ...
    ("equality -> function op term", "equality", 3, "p_equality", "matcher.py", 187),
    (
    ...
    ("equality -> term op term", "equality", 3, "p_equality", "matcher.py", 194),
    ("equality -> term op function", "equality", 3, "p_equality", "matcher.py", 195),
    (
    ...
    ("equality -> equality op term", "equality", 3, "p_equality", "matcher.py", 197),
    (
    ...
    ("op -> EQUALS", "op", 1, "p_op", "matcher.py", 207),
    ("op -> OPERATION", "op", 1, "p_op", "matcher.py", 208),
    (
        "assignment -> var ASSIGNMENT var",
        "assignment",
        3,
    ...
    ("term -> QUOTED_NAME", "term", 1, "p_term", "matcher.py", 226),
    ("term -> QUOTE DATE QUOTE", "term", 3, "p_term", "matcher.py", 227),
    ("term -> QUOTE NUMBER QUOTE", "term", 3, "p_term", "matcher.py", 228),
    ("term -> NUMBER", "term", 1, "p_term", "matcher.py", 229),
    ("term -> REGEX", "term", 1, "p_term", "matcher.py", 230),
    (
        "var_or_header -> header",
        "var_or_header",
        1,
    ...
    ("var_or_header -> var", "var_or_header", 1, "p_var_or_header", "matcher.py", 239),
    ("var -> VAR_SYM NAME", "var", 2, "p_var", "matcher.py", 244),
    ("var -> VAR_SYM NAME_LINE", "var", 2, "p_var", "matcher.py", 245),
    ("header -> HEADER_SYM NAME", "header", 2, "p_header", "matcher.py", 251),
    ("header -> HEADER_SYM NUMBER", "header", 2, "p_header", "matcher.py", 252),
    ("header -> HEADER_SYM NAME_LINE", "header", 2, "p_header", "matcher.py", 253),
]
